...
public class JedisTest {
  ...
  //  @Test
    public void testPublish() {
    	 jedis.flushDB();
        // 发布一个事件
        long r = jedis.publish("event","message_" + System.currentTimeMillis());
        System.out.println(r);
    }
 ...
 // @Test
    public void hamsp(){
    	 jedis.flushDB();
    	  ...
    	  map1.put("user", "zhangsan");
    	  map1.put("sex", "1");
    	  map2.put("user", "lisi");
    	  map2.put("sex", "0");
    	  jedis.hset("FOMF.BASESITE1", "zhangsan","28");
    	  jedis.hset("FOMF.BASESITE1", "lisi","55");
    	  
    	  jedis.hmset("user", map1);
    	  jedis.hmset("user1", map2);
    	  
    	  jedis.hmset("user:aa", map1);
    	  jedis.hmset("user:bb", map1);
    	 
    	  jedis.set("name1","yangxin");
    	  
    	  jedis.sadd("hobbys","吃","喝","玩","乐");
    	  
    	  jedis.sadd("hobbys1",new String[]{"1","2"});
    	  
    	 
    	  
    }
  //  @Test
    public void testPipleLine11() {
    	// jedis.flushDB();
        //System.out.println(jedis.get("key3"));
    	 long r = jedis.setnx("count","200");
    	 jedis.incrBy("count",5);
    	 System.out.println(r+"--"+jedis.get("count"));
    	 System.out.println(r+"--"+jedis.get("count1"));
    }
    @After
    public void after() {
        jedis.close();
